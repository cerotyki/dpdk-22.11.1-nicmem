...
#ifdef HAVE_IBV_FLOW_DV_SUPPORT	
	struct ibv_flow *ret;
	MEASURE("mlx5dv_create_flow",
	ret = mlx5dv_create_flow(matcher,
							match_value,
							num_actions,
...
#ifdef HAVE_IBV_FLOW_DV_SUPPORT
#ifdef HAVE_MLX5DV_DR
	struct mlx5dv_dr_rule *ret;
	MEASURE("mlx5dv_dr_rule_create",
	ret = mlx5dv_dr_rule_create(matcher, match_value, num_actions,
